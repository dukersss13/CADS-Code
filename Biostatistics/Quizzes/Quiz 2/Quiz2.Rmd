...
Quick overview of the coefficients: All of the features chosen are statistiscally significant with the exception of chol.
...
If given more time, an approach I could do to improve the accuracy + AUC of all these models could be to look more into the variables' meanings & do a better job of feature selecting.
